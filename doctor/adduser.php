...
<?php
  ...
  if(isset($_POST['adduser'])){
    $doctorID = mysqli_real_escape_string($dbConnect, $_POST['doctorID']);
    ...
    $query = "INSERT INTO tbldoctor (doctorID, firstname, lastname, username, password, email, phone) VALUES ('$doctorID', '$firstname','$lastname','$username','$password','$email','$phone');";

    $userTypeQuery = "INSERT INTO `tbluserlogin`(`ID`, `username`, `password`, `usertype`, `pharmacyID`, `doctorID`) VALUES (null,'$username','$password','$userType','Default','$doctorID');";

    $result = mysqli_query($dbConnect, $query);
    $Usertyperesult = mysqli_query($dbConnect, $userTypeQuery);
    ...
    <div class="container-fluid">
      ...
      <!-- doctor adding user page -->
        ...
        <form method="post" autocomplete="off">
          <div class="form-group">
            <div class="form-row">
              <div class="col-md-6">
                ...
                <input class="form-control" id="doctorID" name="doctorID" required="required" type="hidden" aria-describedby="nameHelp" value="<?php echo "DR-" .$randNumber; ?>" >
          ...
          <button name="adduser" id="adduser" class="btn btn-primary btn-block">Add User</button>
        </form>
